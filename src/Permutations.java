...
public class Permutations implements Iterator<int[]> {
     ...
     */
    public void buildNextPermutation() {
    ...
    public static void main(String[] args) {
        int n = 3;
        Permutations permutator = new Permutations(n);
        for(int i = 0; i < MainKt.factorial(n); i++) {
            System.out.println(Arrays.toString(permutator.permutation));
